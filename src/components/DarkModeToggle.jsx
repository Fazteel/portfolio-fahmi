...
const DarkModeToggle = () => {
  ...
  return (
    <button
      ...
      className="text-black dark:text-white p-2 rounded flex items-center justify-center"
      aria-label="Toggle Dark Mode"
    >
      {darkMode ? (
        // Ikon untuk dark mode (bulan)
        <svg className="w-6 h-6 text-gray-800 dark:text-white hover:-translate-y-1" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
