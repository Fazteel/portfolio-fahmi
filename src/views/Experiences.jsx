...
const Experience = () => {
    return (
        <div id="experience" className="bg-white dark:bg-gray-800 py-16">
            <div className="max-w-screen-xl mx-auto px-6 md:px-12">
                ...
                <div className="max-w-4xl mx-auto relative border-l border-gray-200 dark:border-gray-700 ml-3 md:ml-auto md:mr-auto md:border-l-0">
                    ...
                    {experiences.map((exp, index) => (
                        <div key={exp.id} className={`relative mb-12 md:mb-16 md:flex ${index % 2 === 0 ? 'md:flex-row-reverse' : ''} justify-between items-center w-full`}>
                            ...
                            <div className="ml-8 md:ml-0 md:w-5/12 bg-gray-50 dark:bg-gray-900 p-6 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 hover:shadow-lg transition-shadow duration-300">
