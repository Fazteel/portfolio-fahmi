...
const Hero = () => {
    ...
    return (
        <div id="home" className="flex flex-col-reverse lg:flex-row items-center justify-center min-h-screen px-6 pt-32 pb-16 lg:px-24 max-w-screen-xl mx-auto gap-12 overflow-hidden">
            
            <motion.div 
                className="flex flex-col items-center text-center lg:items-start lg:text-left flex-1"
                variants={containerVariants}
                initial="hidden"
                animate="visible"
            >
                <motion.p variants={itemVariants} className="text-blue-600 dark:text-blue-400 font-semibold tracking-wide uppercase text-sm mb-2">
                    Welcome to my portfolio
                </motion.p>
                
                <motion.h1 variants={itemVariants} className="mb-4 text-4xl font-extrabold leading-tight text-slate-800 md:text-5xl lg:text-6xl dark:text-white">
                    Hi, I&apos;m <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-cyan-500"><br />Fahmi Andika Setiono</span>
                </motion.h1>
                
                <motion.h2 variants={itemVariants} className="mb-6 text-2xl font-bold text-slate-500 md:text-3xl dark:text-gray-300">
                    Full-Stack Developer
                </motion.h2>
                
                <motion.p variants={itemVariants} className="mb-8 text-lg font-normal text-slate-500 dark:text-gray-400 max-w-xl leading-relaxed">
                ...
                <motion.div variants={itemVariants} className="flex flex-col sm:flex-row gap-4 mb-8">
                    ...
                    <Link to="contact" smooth={true} duration={500} 
                        className="inline-flex items-center justify-center px-8 py-3 text-base font-semibold text-slate-800 transition-all duration-300 bg-transparent border border-gray-300 rounded-full hover:bg-slate-100 hover:-translate-y-1 focus:ring-4 focus:ring-gray-100 dark:text-white dark:border-gray-600 dark:hover:bg-gray-800 dark:focus:ring-gray-800 cursor-pointer">
                        Get in Touch
                    </Link>
                </motion.div>

                <motion.div variants={itemVariants} className="flex gap-5 text-slate-500 dark:text-gray-400">
                    <a href="https://github.com/Fazteel" target="_blank" rel="noopener noreferrer" className="hover:text-slate-800 dark:hover:text-white transition-colors duration-300 hover:-translate-y-1">
